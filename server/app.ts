...
export function createApp(store: Store, monitoring?: MonitoringService, telemetry?: TelemetryService, cmdb?: CmdbService, logs?: LokiService, hardware?: HardwareService, log: StructuredLogger = defaultLogger, auth: AuthConfig = authConfigFromEnvironment(), security: SecurityAuditService = new SecurityAuditService(), backups?: BackupService, collectors?: CollectorService, serviceNow?: ServiceNowCmdbService, proxmoxOperations?: ProxmoxOperationsService, pbsHealth?: PbsHealthService, recoveryDrills?: RecoveryDrillService) {
  const app = express();
