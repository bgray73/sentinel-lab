...
describe('monitoring persistence', () => {
  it('atomically saves and restores monitors and history with private permissions', async () => {
    ...
    const data = { monitors: [], results: [{ id: 'result-1', monitorId: 'monitor-1', status: 'up' as const, latencyMs: 10, detail: 'ok', checkedAt: '2026-01-01T00:00:00Z' }], alertRules: [], incidents: [], deliveries: [], dependencyMappings: [], retentionPolicy:{days:30,maxResults:25_000} };
