...
export type RecoveryAlertSnapshot={status:{enabled:boolean;intervalSeconds:number;cooldownSeconds:number;lastEvaluatedAt:string|null;lastState:RecoveryReadinessSnapshot['state']|null;lastError:string;activeIncidentId:string|null};incident:Incident|null};
